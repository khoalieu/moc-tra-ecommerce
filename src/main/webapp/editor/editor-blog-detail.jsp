...
<head>
    ...
    <title>Chi tiết Bài viết - Mộc Trà Editor</title>
    ...
    <link rel="stylesheet" href="${ctx}/editor/assets/css/editor-blog-detail.css">
        ...
        <div class="admin-content">
            ...
            <div class="blog-detail-header">
                ...
                <div class="blog-actions-top">
                    <a href="${ctx}/editor/blog" class="btn btn-secondary">
                        <i class="fas fa-arrow-left"></i> Quay lại
                    </a>

                    <a class="btn btn-success" href="${ctx}/editor/blog/edit?id=${p.id}">
                        <i class="fas fa-edit"></i> Chỉnh sửa
                    </a>

                    <form method="post" action="${ctx}/editor/blog/delete" style="display:inline;"
                    ...
                    <div class="detail-card">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value"
                                  style="color:#28a745;">${fn:length(empty p.metaTitle ? p.title : p.metaTitle)} ký tự</span>
                        </div>
                        <div class="info-row">
                            <span class="info-label">Meta Description Length:</span>
                            <span class="info-value"
                                  style="color:#28a745;">${fn:length(empty p.metaDescription ? p.excerpt : p.metaDescription)} ký tự</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="display:flex; flex-direction:column; gap:30px;">
                    ...
                    <div class="detail-card">
                        ...
                        <div class="info-row">
                            ...
                            <span class="info-value"><fmt:formatDate value="${p.createdAtDate}"
                    ...
                    <div class="detail-card">
                        ...
                        <div class="stats-grid">
                            <div class="stat-box">
                                <div class="stat-number"><fmt:formatNumber value="${p.viewsCount}"
                                                                           pattern="#,###"/></div>
                    ...
                    <c:forEach var="cm" items="${comments}">
                        ...
                        <div class="comment-item">
                            ...
                            <div class="comment-actions">
                                ...
                                <!-- Delete comment -->
                                <form method="post" action="${ctx}/editor/blog/detail" style="display:inline;"
...
<script>
    function replyComment(postId, commentId, userName) {
        ...
        const v = (txt || '').trim();
        if (!v) {
            location.href = '${ctx}/editor/blog/detail?id=' + postId + '&err=empty';
            return;
        }

        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '${ctx}/editor/blog/detail';
