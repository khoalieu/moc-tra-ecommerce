...
<head>
    ...
    <title>Quản lý Blog - Mộc Trà Editor</title>
        ...
        <header class="admin-header">
            ...
            <div class="header-right">
                <div class="header-search">
                    ...
                    <input id="editorBlogSearch" type="text" name="q" form="blogFilterForm"
        ...
        <div class="admin-content">
            ...
            <div class="page-header">
                ...
                <div class="page-actions">
                    <a href="${pageContext.request.contextPath}/editor/blog/add" class="btn btn-primary">
            ...
            <div class="filters-section">
                <form id="blogFilterForm" method="get" action="${pageContext.request.contextPath}/editor/blog"
                      class="filter-form">
                    <div class="filters-grid">
                        ...
                        <div class="filter-group">
                            ...
                            <select id="sort-filter" class="form-select" name="sort" onchange="this.form.submit()">
                                <option value="date_desc" ${currentSort == 'date_desc' || empty currentSort ? 'selected' : ''}>
                                    Mới nhất
                                </option>
                                <option value="date_asc" ${currentSort == 'date_asc' ? 'selected' : ''}>Cũ nhất</option>
                                <option value="title_asc" ${currentSort == 'title_asc' ? 'selected' : ''}>Tên A-Z
                                </option>
                                <option value="title_desc" ${currentSort == 'title_desc' ? 'selected' : ''}>Tên Z-A
                                </option>
                                <option value="views_desc" ${currentSort == 'views_desc' ? 'selected' : ''}>Xem nhiều
                                    nhất
                                </option>
                                <option value="views_asc" ${currentSort == 'views_asc' ? 'selected' : ''}>Xem ít nhất
                                </option>
                            </select>
                        </div>
                    </div>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <a class="btn-action" title="Xem chi tiết"
                                           href="${pageContext.request.contextPath}/editor/blog/detail?id=${post.id}">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <c:if test="${sessionScope.user.hasPermission('blog.edit') or sessionScope.user.hasPermission('blog.publish') or (sessionScope.user.hasPermission('blog.edit_own') and sessionScope.user.id == post.authorId)}">
                                            <a class="btn-action" title="Chỉnh sửa"
                                               href="${pageContext.request.contextPath}/editor/blog/edit?id=${post.id}">
                ...
                <div class="pagination-container">
                    ...
                    <c:if test="${totalPages > 1}">
                        ...
                        <div class="pagination">
                            <c:url var="prevUrl" value="/editor/blog">
                            ...
                            <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                <c:url var="pageUrl" value="/editor/blog">
                            ...
                            <c:url var="nextUrl" value="/editor/blog">
...
<script>
    ...
    function bulkPublish() {
        ...
        if (confirm(`Bạn có chắc muốn xuất bản \${selectedPosts.length} bài viết đã chọn?`)) {
            ...
            form.method = 'POST';
            form.action = '${pageContext.request.contextPath}/editor/blog/change-status';
    ...
    function deleteSinglePost(postId) {
        ...
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = '${pageContext.request.contextPath}/editor/blog/delete';
