        ...
        <div class="container">
            <c:if test="${not empty order}">
                ...
                <div class="invoice-column">
                    ...
                    <div class="invoice-actions">
                        ...
                        <a href="${pageContext.request.contextPath}/don-hang" class="btn btn-primary">
            ...
            <c:if test="${empty order}">
                <div style="text-align: center; padding: 50px;">
                    ...
                    <a href="${pageContext.request.contextPath}/index" class="btn btn-primary">Về trang chủ</a>
                </div>
            </c:if>
        </div>
    </section>
