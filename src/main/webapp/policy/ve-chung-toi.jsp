...
<main>
    ...
    <section class="about-hero full-height">
        <img src="${pageContext.request.contextPath}/assets/images/about-tong-quan.jpg" alt="Ảnh nền">
    ...
    <section class="section-block" id="story">
        <div class="container">
            <div class="two-col">
                ...
                <div class="col media">
                    <img src="${pageContext.request.contextPath}/assets/images/about-story.png" alt="Câu chuyện hình thành tiệm trà" loading="lazy">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section-block alt" id="mission">
        <div class="container">
            <div class="two-col reverse">
                <div class="col media">
                    <img src="${pageContext.request.contextPath}/assets/images/about-mission.png" alt="Mục tiêu và sứ mệnh" loading="lazy">
                </div>
                <div class="col text">
    ...
    <section class="section-block" id="values">
        <div class="container">
            <div class="two-col">
                ...
                <div class="col media">
                    <img src="${pageContext.request.contextPath}/assets/images/about-values.png" alt="Giá trị cốt lõi" loading="lazy">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="about-section section-block" id="about-section">
        ...
        <div class="about-row">
            ...
            <div class="about-image">
                <img src="${pageContext.request.contextPath}/assets/images/image-muc-tieu.png" alt="Ảnh minh họa lớn">
            </div>
        </div>

        <div class="about-row">
            <div class="about-image">
                <img src="${pageContext.request.contextPath}/assets/images/image-tra-thao-moc.png" alt="Trà thảo mộc">
            </div>
            <div class="about-text">
                <h2>Trà Thảo Mộc</h2>
        ...
        <div class="about-row">
            ...
            <div class="about-image">
                <img src="${pageContext.request.contextPath}/assets/images/image-tra-sua-nguyen-lieu.png" alt="Trà sữa nguyên liệu">
            </div>
        </div>
    </section>
    ...
    <section class="about-bottom section-block" id="about-bottom">
        <div class="feature-row">
            <div class="feature"><img src="${pageContext.request.contextPath}/assets/images/icon-about1.png"><h4>Chất Lượng Là Hàng Đầu</h4></div>
            <div class="feature"><img src="${pageContext.request.contextPath}/assets/images/icon-about2.png"><h4>Cam Kết Nguồn Gốc</h4></div>
            <div class="feature"><img src="${pageContext.request.contextPath}/assets/images/icon-about3.png"><h4>Thân Thiện Môi Trường</h4></div>
            <div class="feature"><img src="${pageContext.request.contextPath}/assets/images/icon-about4.png"><h4>Lắng Nghe Khách Hàng</h4></div>
        </div>
        ...
        <div class="container">
            <div class="cta-box">
                ...
                <div style="display:flex; justify-content:center; gap:16px; flex-wrap:wrap;">
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/product/tra-thao-moc.jsp">Trà Thảo Mộc</a>
                    <a class="btn btn-primary" href="${pageContext.request.contextPath}/product/tra-sua-nguyen-lieu.jsp">Trà Sữa Nguyên Liệu</a>
                </div>
            </div>
        </div>
    </section>
