...
public class DatabaseInitializer {
    public static void main(String[] args) {
        ...
        try (Connection conn = DriverManager.getConnection(url, user, password)) {
            ...
            // 1. Ensure CSKH and MARKETING roles exist
            ...
            // 2. Define missing permissions: name, display_name, group_name
            String[][] missingPerms = {
            ...
            for (String[] perm : missingPerms) {
                ...
                if (permId > 0) {
                    // Map to ADMIN (role_id = 1)
                    mapPermissionToRole(conn, 1, permId, name, "ADMIN");

                    // Map specific editor permissions to EDITOR (role_id = 3)
                    ...
                    // Map specific marketing and CSKH permissions
            ...
            // Map existing permissions for MARKETING and CSKH roles
